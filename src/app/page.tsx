  ...
  const roleCards = [
    {
      ...
      role: "Novice Wizard",
      icon: "🔮",
      description: "Apprentice Elite learning the mystical arts",
    ...
    },
    {
      ...
      role: "Master Wizard",
      icon: "⚡",
      description: "Experienced Elite teaching the next generation",
    ...
    },
    {
      ...
      role: "Grand Master",
      icon: "👑",
      description: "The supreme leader of Elite Academy",
